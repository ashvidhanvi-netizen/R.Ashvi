...
window.FutureHorizon = (function () {
  ...
  function setupQuantumVisualizer() {
    ...
    function drawQubit(prob1) {
      ...
      qCtx.strokeStyle = 'rgba(124, 58, 237, 0.25)';
      qCtx.lineWidth = 1.5;
      ...
      qCtx.moveTo(cx, cy);
      qCtx.lineTo(vx, vy);
      qCtx.strokeStyle = '#059669';
      qCtx.lineWidth = 3.5;
      qCtx.shadowColor = 'rgba(5, 150, 105, 0.4)';
      qCtx.shadowBlur = 10;
      qCtx.stroke();
      qCtx.shadowBlur = 0;
      ...
      qCtx.fillStyle = '#10B981';
      qCtx.shadowColor = 'rgba(16, 185, 129, 0.6)';
      qCtx.shadowBlur = 14;
      qCtx.fill();
      qCtx.shadowBlur = 0;
    }
  ...
  function setupMeasurementCollapse() {
    ...
    measureBtn.addEventListener('click', () => {
      ...
      if (resultDisplay) {
        ...
        resultDisplay.style.color = collapsedToState1 ? '#059669' : '#7C3AED';
