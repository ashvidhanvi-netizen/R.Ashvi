  ...
  dossier.innerHTML = `
    ...
    <div class="kg-stats-row">
      ...
      <div class="kg-stat-box">
        ...
        <div class="kg-stat-label">Est. Retrieval Time</div>
      </div>
      <div class="kg-stat-box">
    ...
    <div class="p-3 rounded bg-black bg-opacity-40 border border-secondary border-opacity-10 text-secondary small">
      ...
      "Card catalog cross-indexed across physical repository halls. Curated manuscripts pulled and verified by Chief Cataloger on duty. Physical access slip registered in central ledger."
    </div>
  `;
